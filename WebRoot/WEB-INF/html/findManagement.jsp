...
<div>
    <div class="findHeader">
        <a class="findLink" href="findManagement.html"><div><input type="button" value="草稿箱" class="findHeaderInputClick"></div></a>
    ...
    <div class="findTableOut">
        <table class="findTable">
            ...
            <tr class="findTableTrText">
                ...
                <td><a href="findEdit.html"><input type="button" value="编辑" class="findTableTrTextSure"></a><input type="button" value="发送" class="findTableTrTextNo"><input type="button" value="删除" class="findTableTrTextDel"></td>
            </tr>
            <tr class="findTableTrText">
                <td>2</td>
                <td>我的梦想</td>
                ...
                <td>我是一个天才，哈哈哈哈</td>
                <td><a href="findArticleDetail.html"><img src="../img/20180123162043.png"></a></td>
                <td><input type="button" value="编辑" class="findTableTrTextSure"><input type="button" value="发送" class="findTableTrTextNo"><input type="button" value="删除" class="findTableTrTextDel"></td>
            </tr>
            <tr class="findTableTrText">
                <td>3</td>
                <td>我的梦想</td>
