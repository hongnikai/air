...
<div class="caiM_all">
    <div class="caiM_divheader">
        <div class="caiM_divheader_div1">
            ...
            <input type="button" onclick="fun2()" value="未完成"/>
    ...
    <div class="caiM_TableOut">
        ...
        <div class="caiM_Footer">
            <div class="caiM_FooterPage">
                <a href="../backageController/commodity_orderY.do?pageNumber=${min}"><input type="button" value="上一页"/></a>
                <span>当前第${middle}页,共${page}页</span>
                <a href="../backageController/commodity_orderY.do?pageNumber=${num}"><input type="button" value="下一页"/></a>
            </div>
        </div>
        </c:if>
    </div>
