...
<div class="userMD_all">
    <div class="userMD_divheader">
       <div class="userMD_divheader_div1">
        ...
        <div>
        	...
        	<%-- <select>
        		<option value="../backageController/targetUserMangementDetail.do?au_id=${list[0].au_id}">商品订单</option>
        		<option onclick="fun1()">安装订单</option>
        		<option value="www.baidu.com">保养订单</option>
        		<option value="../">维修订单</option>
        	</select>  --%>
        </div>
   ...
   <c:if test='${not empty "${list}"}'>
            ...
            <tr class="userMD_TableTrText">
                ...
                <td><span class="userMD_activespan2">订单</span></td>
    ...
    <div class="userMD_divfooter">
       <%--  <div class="userMD_page">
            <a href="../backageController/targetUserMangementDetail.do?au_id=${list[0].au_id}&pageNumber=${min}"><input type="button" value="上一页" /></a>
            <span>当前第${middle}页,共${page}页</span>
            <a href="../backageController/targetUserMangementDetail.do?au_id=${list[0].au_id}&pageNumber=${num}"><input type="button" value="下一页"/></a>
        </div> --%>
    </div>
     </c:if>
</div>
 ...
 <script type="text/javascript">
	...
	function sousuo(){
		alert("进入搜索方法");
		var s=$("#key").val();
		window.location.href="../backageController/selectCommodityOrderByKeyWords.do?keywords="+s;
	}
