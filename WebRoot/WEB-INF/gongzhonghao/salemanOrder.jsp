...
<html>
	...
	<body class="bgcGray">
		...
		<nav class="orderNav">
			...
			<span><a href="../commodity/commodityOrderNotComplete.do?au_id=${user.au_id}">未完成</a></span>
			<span><a href="../commodity/commodityOrderComplete?au_id=${user.au_id}">已完成</span>
		</nav>
		...
		<c:forEach items="${commodityOrder}" var="data" varStatus="s"> 
			<section class="orderBox">
				<p class="margin05"><span class="greenFont">单号${data.com_id}</span>
					...
					<a href="../commodity/salemanGetCommodityOrder.do?au_id=${user.au_id}&com_id=${data.com_id}" class="greenBtn fr">接单</a>
				</p>
				<div class="orderInfo">
