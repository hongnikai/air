...
<form action="../RepairController/createRepairOrderGongZhongHao.do">
	<body>
		<header class="header">
	     <input name="repair_id" type="hidden"  value="${repair.repair_id}"/> 
		 <input name="a_id" type="hidden" value="${address.a_id}" /> 
