...
<html>
	...
	<body>
		<header class="header bB0">
			<a href="../userController/targetchangUserInformation.do?au_id=${user.au_id}"><img src="../img/icon_user_set@2x.png" /></a>
			<a class="r0" ><img src="../img/icon_user_msg@2x.png"/></a>
		</header>
		<div class="headshot center mT5">
			<a><img src="${user.headimg}" /></a>
			<center>技术员${user.nickname}</center>
		</div>
		<p class="personLine">
			<span>我的订单</span>
			<a href="../InstallController/targetJiShuWaitForGet.do?au_id=${user.au_id}" class="fr">查看全部</a>
		</p>
		<div class="personOrder center">
			<a href="../InstallController/targetJiShuComplete.do?au_id=${user.au_id}">
				<img src="../img/completed.png" /> 已完成
			</a>
			<a href="../InstallController/targetJiShuNotComplete.do?au_id=${user.au_id}">
