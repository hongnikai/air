...
<!DOCTYPE html>
<html>
<form action="../commodity/chooseCommodityByParameter.do">
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<c:forEach items="${commodity}" var="data" varStatus="s">
			<a href="../commodity/selectCommodityBycIdAndTarget.do?c_id=${data.c_id}">  
		...
		<input type="hidden" value="0" name="use_type" id="use_type">
		...
		<div class="commodityPopUp">
			...
			<li>
				...
				<li>
					<h3>空调种类</h3>
					<span onclick="change_use_type('0')">家用分体式</span>
					<span onclick="change_use_type('1')">家用中央式</span>
				</li>
				<li>
					<h3>分类</h3>
...
$(".showNav>span#price").toggle(function() { /*价格升降*/
	...
	$.ajax({
		url:"../commodity/selectCommodityByMark.do",
		type:"post",
		data:{"mark":2},
		success:function(data){
					var html=$(".hotSell").html("");
					for(i=0;i<data.length;i++){
					var	str="<a href='../commodity/selectCommodityBycIdAndTarget.do?c_id="+data[i].c_id+"'>";
