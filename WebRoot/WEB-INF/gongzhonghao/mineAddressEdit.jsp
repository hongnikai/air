...
<html>
	...
	<body class="bgcGray">
		...
		<form action="../InstallController/createGongZhongHaoAddress.do">
				<input type="text" value="${install_id}" name="install_id" style="display: none;"/>
				<input type="text" value="${au_id}" name="au_id" style="display: none;"/>
				<input type="text" value="${a_id}">
