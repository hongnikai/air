...
<html>
	...
	<body class="bgcGray">
		...
		<nav class="orderNav">
			<span class="navAct">已评价</span>
			<a href="http://www.kongtiaoguanjia.com/air/commodity/centralOrderState8BySign.do?au_id=${user.au_id}"><span>未付款</span></a>
			<a href="http://www.kongtiaoguanjia.com/air/commodity/centralOrderState8BySign.do?sign=1"><span>已付款</span></a>
		</nav>
